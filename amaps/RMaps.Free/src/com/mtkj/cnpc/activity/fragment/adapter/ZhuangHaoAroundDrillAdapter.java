 ...
 * 
 */
public class ZhuangHaoAroundDrillAdapter extends BaseAdapter implements
		ListAdapter {
	public Context context = null;
	public LayoutInflater layoutInflater = null;
	public int nSelected = 0;
	public List<DrillPoint> lstTaskEntities = new ArrayList<DrillPoint>();

	public ZhuangHaoAroundDrillAdapter(Context context,
                                       List<DrillPoint> lstDatas, Location location) {
		...
		if (lstDatas != null && lstDatas.size() > 0) {
			...
			// 排序
			Collections.sort(lstTaskEntities, new Comparator<DrillPoint>() {

				@Override
				public int compare(DrillPoint lhs, DrillPoint rhs) {
					// TODO Auto-generated method stub
					return ((String) lhs.time).compareTo((String) rhs.time);
				}
			});
			lstDatas.clear();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		DrillPoint taskEntity = lstTaskEntities.get(position);
