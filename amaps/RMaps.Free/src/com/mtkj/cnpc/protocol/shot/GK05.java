...
/**
 * 取消排队反馈<br>
 * GK05;手持Id;结果标志（1成功;0失败）;<br>
 * 例如:GK05;1;1;</br>
 * 
 * @author drh
 *
 */
public class GK05 extends ReceiveBody {

	public boolean isOk = false;
	public String errorInfo = "";
	public String error01 = "取消排队失败";

	public GK05(String content) {
		super(ProtocolConstants.NAME_JINGPAO.GK05, content);
	}
