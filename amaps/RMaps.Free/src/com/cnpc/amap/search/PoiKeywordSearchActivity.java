...
//						aMap.clear();// 清理之前的图标
//						SharePosOverlay poiOverlay = new SharePosOverlay(aMap, poiItems);
...
//						poiOverlay.zoomToSpan();
						...
						for (int i = 0; i < poiItems.size(); i++) {
							...
							GeoPoint geoPoint = GeoPoint.fromDouble(poiItem.getLatLonPoint().getLatitude(), poiItem.getLatLonPoint().getLongitude());
							geoPoints.add(geoPoint);
							String string = poiItem.getTitle() + "\n" + poiItem.getSnippet();
							strings.add(string);
						}
						SearchResultOverlay.setSearchResult(geoPoints, strings);
