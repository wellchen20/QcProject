...
public class BorderedText {
  ...
  public void drawBitmp(final Canvas canvas, final float posX, final float posY, Bitmap bitmap)
  {

    canvas.drawBitmap(bitmap,posX,posY,exteriorPaint);
    canvas.drawBitmap(bitmap,posX,posY,interiorPaint);
  }
  public void drawBitmp(final Canvas canvas, Rect rect, RectF rectF, Bitmap bitmap)
  {
    canvas.drawBitmap(bitmap,null,rectF,exteriorPaint);
    canvas.drawBitmap(bitmap,null,rectF,interiorPaint);
  }
